package top.luyuni.ad.sender.index;
...
import top.luyuni.ad.dump.table.*;
import top.luyuni.ad.handler.AdLevelDataHandler;
import top.luyuni.ad.index.DataLevel;
    ...
    private void Level3RowData(MySqlRowData rowData) {
        ...
        if (rowData.getTableName().equals(
            ...
            for (Map<String, String> fieldValueMap : rowData.getFieldValueMap()) {
                ...
                System.out.println(fieldValueMap + " -------------------------------------------Level3RowData");
                fieldValueMap.forEach((k, v) -> {
                    switch (k) {
